...
class NTTransition : NSObject , UIViewControllerAnimatedTransitioning{
    ...
    func animateTransition(transitionContext: UIViewControllerContextTransitioning) {
        ...
        if presenting {
            ...
            let leftUpperPoint = gridView!.convertPoint(CGPointZero, toView: containerView)
            ...
            snapShot.origin(CGPointMake(leftUpperPoint.x, leftUpperPoint.y))    // the same
            // println(offsetStatuBar)
            ...
            UIView.animateWithDuration(animationDuration, animations: {
                ...
                // fromView.frame = CGRectMake(0, 0, screenWidth, screenHeight)
                    ...
                    if finished {
                        ...
                        // If the page is already huge.......
                        if(CGRectGetHeight(snapShot.frame)>500){
